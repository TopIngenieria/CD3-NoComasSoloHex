package co.edu.eafit.nocomasolo.post.data.dao.factory;
...
import co.edu.eafit.nocomasolo.post.data.dao.mongo.MongoPostDAO;
...
/*	public UserDAO crearUserDAO() {
	...
	public PostDAO crearPostDAO(){
		if (this.postDAO == null) {
			this.postDAO = new MongoPostDAO();
